...
core_technology/job_profile/work_objective_1~3/team_refer, 2026-09-01
갱신)은 원본 파일 자체에 시점 컬럼이 없어, 한 번에 파일 1개 + 관리자가
고른 날짜 1개만 반영할 수 있었다. 여러 달치를 한꺼번에 올리고 싶을 때는,
파일명 끝에 "_YYYYMM"을 붙여서 그 파일이 어느 시점 기준인지 파일명
자체에서 알 수 있게 한다(예: "T&P 기본 인사 정보_202305.xlsx",
"핵심기술_202305.xlsx").
